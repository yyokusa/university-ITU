...
int main()
{
    ...
    int **parking_area;
    parking_area = init_matrix(size);

    // Fill cars into parking space
    int x, y;
    int counter = 0;
    bool any_car_inside = false;
    ...
    distances_matrix = init_matrix(size);
...
/** 
 * Initialize distances_matrix and parking_area with dynamic memory allocation
